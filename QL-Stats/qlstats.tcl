...
proc qlstats::getLastMatch {player chan} {
	...
	#
	set weaponList [list GAUNTLET \0030GT\003 MACHINEGUN \0038MG\003 SHOTGUN \0035SG\003 GRENADE \0033GL\003 ROCKET \0034RL\003 LIGHTNING \0030LG\003 RAILGUN \0033RG\003 PLASMA \0036PG\003 BFG \0032BFG\003 CHAINGUN \00314CG\003 NAILGUN	\00310NG\003 PROXMINE \00313PM\003];
	...
	#
	if {[regexp -- {\s+SCOREBOARD\s+} [dict keys $data]]} {
		foreach value [dict get $data SCOREBOARD] {
			if {[string tolower [dict get $value PLAYER_NICK]] == $player} {
